...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- Vendor JS Files -->
        <script src="{{ URL::asset('vendor/jquery/jquery.min.js') }}" defer></script>
        <script src="{{ URL::asset('vendor/bootstrap/js/bootstrap.bundle.min.js') }}" defer></script>
        <script src="{{ URL::asset('vendor/jquery.easing/jquery.easing.min.js') }}" defer></script>
        <script src="{{ URL::asset('vendor/php-email-form/validate.js') }}" defer></script>
        <script src="{{ URL::asset('vendor/waypoints/jquery.waypoints.min.js') }}" defer></script>
        <script src="{{ URL::asset('vendor/isotope-layout/isotope.pkgd.min.js') }}" defer></script>
